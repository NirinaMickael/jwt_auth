...
exports.ConnnectDataBase = void 0;
var mongodb_1 = require("mongodb");
var uri = "mongodb+srv://Mickael:55zDxhTbEZuPf6Hi@newcluster.aqemw.mongodb.net/?retryWrites=true&w=majority";
var ConnnectDataBase = /** @class */ (function () {
    function ConnnectDataBase() {
        ConnnectDataBase.client = new mongodb_1.MongoClient(uri);
    }
    ConnnectDataBase.open = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ConnnectDataBase.client.connect()];
                    case 1:
                        _a.sent();
                        console.log("okey ");
                        return [3 /*break*/, 4];
                    case 2:
                        ...
                        return [3 /*break*/, 4];
                    case 3:
                        setTimeout(function () { ConnnectDataBase.client.close(); }, 1500);
                        return [7 /*endfinally*/];
    ...
    ConnnectDataBase.prototype.getDb = function () {
        return ConnnectDataBase.client;
    };
    return ConnnectDataBase;
}());
exports.ConnnectDataBase = ConnnectDataBase;
;
